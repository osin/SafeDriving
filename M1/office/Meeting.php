<?php include '../common/inc/init.inc';
 Begin('Planifier une session', true, 'Planifier une session');
?>
<p>Ici vous pouvez créer des sesions, Une fois une sessions créer, celle ci est disponible pour tout les intervenants.
Vous pourrez toutefois explicitement associer une session à un intervenant</p>
	<div id='calendar'></div>
...
$(document).ready(function() {
   ...
   $calendar.weekCalendar({
      ...
      eventNew : function(calEvent, $event) {
          var nb_voitures = <?php echo count($vehicles); ?>;
          if (nb_voitures < 1) {
            alert(nb_voitures);
            location.reload();
            return false;
